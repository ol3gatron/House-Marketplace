...
function Profile() {
  ...
  const [listsings, setListsings] = useState(null)
  ...
  const onDelete = async (listingId) => {
    if (window.confirm("Are you sure you want to delete?")) {
      ...
      const updatedListings = listsings.filter((listing) => listing.id !== listingId)
      setListsings(updatedListings)
